---
title: "1K generations isolation, test fixed diffs"
author: "Devon DeRaad"
date: '2023-01-23'
...
model <- compile_model(populations = list(pop1,pop2),
                       generation_time = 1,
                       sim_length = 1050,
                       path = "~/Desktop/hybrid.sims/slendr.output/1K",
...
#schedule sampling
present_samples <- schedule_sampling(model, times = 1050, list(pop1, 1000), list(pop2, 1000), strict = TRUE)
present_samples
...
#write out vcf
ts_vcf(ts, path = "~/Desktop/hybrid.sims/slendr.output/1K/output.vcf.gz")
```

### prepare input file for testing 
```{r}
#read in vcf
vcfR<-read.vcfR("~/Desktop/hybrid.sims/slendr.output/1K/output.vcf.gz")
vcfR
